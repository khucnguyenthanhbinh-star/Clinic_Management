...
class ManageAppointmentsView(ttk.Frame):
    def __init__(self, parent, controller):
        ...
        ttk.Label(top_frame, text="QUẢN LÝ LỊCH HẸN", font=("Arial", 16, "bold")).pack(side="left")
...
Trạng thái: {appointment['status']}
    ...
    def change_status(self):
        ...
        ttk.Label(change_win, text=f"Trạng thái hiện tại: {current_status}", font=("Arial", 10)).pack(pady=10)
