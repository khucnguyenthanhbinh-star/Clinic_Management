...
class ManagePatientsView(ttk.Frame):
    def __init__(self, parent, controller):
        ...
        ttk.Label(top_frame, text="QUẢN LÝ BỆNH NHÂN", font=("Arial", 16, "bold")).pack(side="left")
        ...
        ttk.Button(btn_frame, text="Tạo mới", command=self.create_patient).pack(side="left", padx=5)
...
Bảo hiểm: {info.get('insurance', 'N/A')}
    ...
    def edit_patient(self):
        ...
        ttk.Label(edit_win, text="Cập nhật thông tin bệnh nhân", font=("Arial", 12, "bold")).pack(pady=10)
    ...
    def create_patient(self):
        ...
        ttk.Label(create_win, text="Tạo bệnh nhân mới", font=("Arial", 12, "bold")).pack(pady=10)
