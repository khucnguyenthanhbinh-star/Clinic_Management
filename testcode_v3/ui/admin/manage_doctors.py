...
class ManageDoctorsView(ttk.Frame):
    def __init__(self, parent, controller):
        ...
        ttk.Label(top_frame, text="QUẢN LÝ BÁC SĨ", font=("Arial", 16, "bold")).pack(side="left")
...
Hình ảnh: {info.get('image', 'N/A')}
    ...
    def edit_doctor(self):
        ...
        ttk.Label(edit_win, text="Cập nhật thông tin bác sĩ", font=("Arial", 12, "bold")).pack(pady=10)
    ...
    def create_doctor(self):
        ...
        ttk.Label(create_win, text="Tạo bác sĩ mới", font=("Arial", 12, "bold")).pack(pady=10)
