...
class ManageUsersView(ttk.Frame):
    def __init__(self, parent, controller):
        ...
        tk.Label(top_frame, text="QUẢN LÝ TÀI KHOẢN", font=("Arial", 16, "bold")).pack(side="left")
        ...
        # Bind focus event để reload data khi tab được mở
        self.bind("<Visibility>", lambda e: self.refresh_list())
...
Thông tin bổ sung: {user_data.get('info', 'N/A')}
    ...
    def change_password(self):
        ...
        tk.Label(change_win, text=f"Đặt mật khẩu mới cho: {username}", font=("Arial", 11, "bold")).pack(pady=10)
    ...
    def create_user(self):
        ...
        tk.Label(create_win, text="Tạo tài khoản mới", font=("Arial", 12, "bold")).pack(pady=10)
