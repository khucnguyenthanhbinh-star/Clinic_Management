...
class LoginWindow(ttk.Frame):
    ...
    def create_widgets(self):
        ...
        ttk.Label(frame, text="ĐĂNG NHẬP", font=("Arial", 20, "bold"), foreground="#007bff").grid(row=0, column=0, columnspan=2, pady=20)
...
class RegisterWindow(ttk.Frame):
    ...
    def create_widgets(self):
        ...
        ttk.Label(frame, text="ĐĂNG KÝ TÀI KHOẢN", font=("Arial", 20, "bold"), foreground="#28a745").grid(row=0, column=0, columnspan=2, pady=20)
