...
class BookAppointmentView(ttk.Frame):
    def __init__(self, parent, controller):
        ...
        self.header_lbl = ttk.Label(self, text="ĐẶT LỊCH KHÁM", font=("Arial", 16, "bold"), foreground="#007bff")
    ...
    def show_step_1_clinic(self):
        ...
        ttk.Label(frame, text="Vui lòng chọn cơ sở khám:", font=("Arial", 12)).pack(anchor="w", pady=20)
    ...
    # ================= BƯỚC 5: THÔNG TIN (KIỂM TRA CHẶT CHẼ) =================
    ...
    def save_step_5(self):
        ...
        if self.booking_data["is_relative"]:
            # ĐẶT HỘ: Kiểm tra form nhập liệu
            ...
            # ĐẶT CHO MÌNH: Kiểm tra hồ sơ trong DB
            ...
            if missing:
                ...
                if messagebox.askyesno("Hồ sơ chưa đạt chuẩn", msg + "\n\nBạn có muốn đến trang Cập nhật hồ sơ ngay không?"):
                    # Chuyển hướng sang trang Update Info
    ...
    def show_step_6_confirm(self):
        self.clear_container()
        self.header_lbl.config(text="BƯỚC 6: XÁC NHẬN")
        ...
        for l in lines: 
            ...
            ttk.Label(f_info, text=l, font=f, foreground=c).pack(anchor="w", pady=2)
