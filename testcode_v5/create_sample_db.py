...
def create_sample_data():
    ...
    # 3. TẠO KHO THUỐC
    medicines = [
        ("Paracetamol 500mg", 500, "Viên",5000), ("Amoxicillin 500mg", 200, "Viên",5000),
        ("Vitamin C 500mg", 100, "Lọ",5000), ("Siro ho Prospan", 50, "Chai",80000),
        ("Amlodipin 5mg", 300, "Viên",5000), ("Berberin", 100, "Lọ",7000),
        ("Oresol", 200, "Gói",5000), ("Fucidin Cream", 40, "Tuýp",7000)
    ]
