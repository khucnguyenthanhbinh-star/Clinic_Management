...
from ui.admin import manage_doctors, manage_patients, manage_appointments, manage_medicines, manage_users, reports, manage_invoices
...
class MainWindow(ttk.Frame):
    ...
    def create_menu(self, parent):
        ...
        if role == "patient":
            ...
            self.add_btn(parent, "Quản lý hóa đơn", lambda: self.switch_view(manage_invoices.ManageInvoicesView))
